...
public class ModLootTableModifiers {
    ...
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> BASIC_UPGRADE_TEMPLATE =
    ...
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> COBALT_STEEL_UPGRADE_TEMPLATE =
            LOOT_MODIFIER_SERIALIZERS.register("loot_cobalt_steel_upgrade_template",
                    ModCobaltSteelUpgradeTemplateModifier.CODEC);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> INFUSED_GEMSTONE_UPGRADE_TEMPLATE =
            LOOT_MODIFIER_SERIALIZERS.register("loot_infused_gemstone_upgrade_template",
                    ModInfusedGemstoneUpgradeTemplateModifier.CODEC);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> NETHERITE_UPGRADE_TEMPLATE =
            LOOT_MODIFIER_SERIALIZERS.register("loot_netherite_upgrade_template",
                    ModNetheriteUpgradeTemplateModifier.CODEC);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> TUNGSTEN_CARBIDE_UPGRADE_TEMPLATE =
            LOOT_MODIFIER_SERIALIZERS.register("loot_tungsten_carbide_upgrade_template",
                    ModTungstenCarbideUpgradeTemplateModifier.CODEC);

    //Basic ingredients
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> BRONZE_INGOT =
            LOOT_MODIFIER_SERIALIZERS.register("loot_bronze_ingot",
                    ModBronzeIngotLootModifier.CODEC);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> PHOSPHATE_POWDER =
            LOOT_MODIFIER_SERIALIZERS.register("loot_phosphate_powder",
                    ModPhosphatePowderLootModifier.CODEC);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> TIN_INGOT =
            LOOT_MODIFIER_SERIALIZERS.register("loot_tin_ingot",
                    ModTinIngotLootModifier.CODEC);

    //Upgrade ingredients
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> COBALT_SHARD =
            LOOT_MODIFIER_SERIALIZERS.register("loot_cobalt_shard",
                    ModCobaltShardLootModifier.CODEC);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> RUBY =
            LOOT_MODIFIER_SERIALIZERS.register("loot_ruby",
                    ModRubyLootModifier.CODEC);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> SAPPHIRE =
            LOOT_MODIFIER_SERIALIZERS.register("loot_sapphire",
                    ModSapphireLootModifier.CODEC);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> STEEL_INGOT =
            LOOT_MODIFIER_SERIALIZERS.register("loot_steel_ingot",
                    ModSteelIngotLootModifier.CODEC);
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> TUNGSTEN_INGOT =
