...
//                    ModCommonConfigs.ENDGAME_TIER_EFFECT_SECONDS.get() * 20, 0));
     ...
     */
    public static void appendCobaltSteelEquipmentTooltip(Consumer<Component> tooltip, EquipmentType type) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.accept(Component.translatable("tooltip.cobalt_steel_details_0"));
            tooltip.accept(Component.translatable("tooltip.cobalt_steel_details_1"));
            tooltip.accept(Component.translatable("tooltip.cobalt_steel_details_2"));
            tooltip.accept(Component.translatable("tooltip.cobalt_steel_details_3"));
            tooltip.accept(Component.translatable("tooltip.cobalt_steel_details_4"));

            //TODO: RE-IMPLEMENT CONFIGS
            switch (type) {
                case ARMOR -> {
                    tooltip.accept(Component.translatable("tooltip.cobalt_steel_armor"));
                }
                case TOOL -> {
                    tooltip.accept(Component.translatable("tooltip.cobalt_steel_onhit"));
                }
                case RANGED -> {
                    tooltip.accept(Component.translatable("tooltip.cobalt_steel_bow_crossbow"));
                    tooltip.accept(Component.translatable("tooltip.cobalt_steel_onhit"));
                }
            }
        } else {
...
//                    (ModCommonConfigs.ENDGAME_TIER_EFFECT_SECONDS.get() * 20) + 1, 1));
     ...
     * @param type What type of equipment to generate the tooltip for (different for each)
     */
    public static void appendInfusedGemstoneEquipmentTooltip(Consumer<Component> tooltip, EquipmentType type) {
        //This method should only ever be called client-side, so no null risk here.
        //If the player is holding shift, show detailed info.
        if (Screen.hasShiftDown()) {
            tooltip.accept(Component.translatable("tooltip.infused_gemstone_details_0"));
            tooltip.accept(Component.translatable("tooltip.infused_gemstone_details_1"));
            tooltip.accept(Component.translatable("tooltip.infused_gemstone_details_2"));
            tooltip.accept(Component.translatable("tooltip.infused_gemstone_details_3"));
            tooltip.accept(Component.translatable("tooltip.infused_gemstone_details_4"));

            //TODO: RE-IMPLEMENT CONFIGS
            switch (type) {
                case ARMOR -> {
                    tooltip.accept(Component.translatable("tooltip.infused_gemstone_armor"));
                }
                case TOOL -> {
                    tooltip.accept(Component.translatable("tooltip.infused_gemstone_onhit"));
                }
                case RANGED -> {
                    tooltip.accept(Component.translatable("tooltip.infused_gemstone_bow_crossbow"));
                    tooltip.accept(Component.translatable("tooltip.infused_gemstone_onhit"));
                }
            }
        } else {
...
//                    ModCommonConfigs.ENDGAME_TIER_EFFECT_SECONDS.get() * 20, 1));
     ...
     * @param type What type of equipment to generate the tooltip for (different for each)
     */
    public static void appendTungstenCarbideEquipmentTooltip(Consumer<Component> tooltip, EquipmentType type) {
        //This method should only ever be called client-side, so no null risk here.
        //If the player is holding shift, show detailed info.
        if (Screen.hasShiftDown()) {
            tooltip.accept(Component.translatable("tooltip.tungsten_carbide_details_0"));
            tooltip.accept(Component.translatable("tooltip.tungsten_carbide_details_1"));
            tooltip.accept(Component.translatable("tooltip.tungsten_carbide_details_2"));
            tooltip.accept(Component.translatable("tooltip.tungsten_carbide_details_3"));
            tooltip.accept(Component.translatable("tooltip.tungsten_carbide_details_4"));

            //TODO: RE-IMPLEMENT CONFIGS
            switch (type) {
                case ARMOR -> {
                    tooltip.accept(Component.translatable("tooltip.tungsten_carbide_armor"));
                }
                case TOOL -> {
                    tooltip.accept(Component.translatable("tooltip.tungsten_carbide_onhit"));
                }
                case RANGED -> {
                    tooltip.accept(Component.translatable("tooltip.tungsten_carbide_bow_crossbow"));
                    tooltip.accept(Component.translatable("tooltip.tungsten_carbide_onhit"));
                }
            }
        } else {
