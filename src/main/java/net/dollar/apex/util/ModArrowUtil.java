...
public class ModArrowUtil {
    ...
    public static AbstractArrow createCustomArrow(Level level, LivingEntity shooter,
                                                  ItemStack arrowStack, ItemStack weaponStack, ArrowType type) {
        ModCustomArrowEntity arrowEntity = new ModCustomArrowEntity(level, shooter, arrowStack, weaponStack, type);
