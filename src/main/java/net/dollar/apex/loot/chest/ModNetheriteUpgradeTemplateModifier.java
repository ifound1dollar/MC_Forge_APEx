...
public class ModNetheriteUpgradeTemplateModifier extends LootModifier {
     ...
     */
    protected ModNetheriteUpgradeTemplateModifier(LootItemCondition[] conditionsIn, Item item) {
        super(conditionsIn);
        this.item = item;
    }
    ...
    protected @NotNull ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        ...
        //COMMON (NOTE: Removed all Bastion instances because already in loot pool)
        if (chest.equals( ModLootUtils.ANCIENT_CITY_ID) || chest.equals( ModLootUtils.WOODLAND_MANSION_ID)) {
        ...
        //UNCOMMON (NOTE: Removed all Bastion instances because already in loot pool)
        //None.
