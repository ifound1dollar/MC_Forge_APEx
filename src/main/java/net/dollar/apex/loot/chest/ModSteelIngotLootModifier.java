...
public class ModSteelIngotLootModifier extends LootModifier {
    public static final Supplier<MapCodec<ModSteelIngotLootModifier>> CODEC = Suppliers.memoize(() ->
            RecordCodecBuilder.mapCodec(inst -> codecStart(inst).and(ForgeRegistries.ITEMS.getCodec()
                    .fieldOf("item").forGetter(m -> m.item)).apply(inst, ModSteelIngotLootModifier::new)));
    final Item item;
