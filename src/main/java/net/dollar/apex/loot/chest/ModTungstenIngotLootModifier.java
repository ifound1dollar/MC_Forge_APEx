...
public class ModTungstenIngotLootModifier extends LootModifier {
    public static final Supplier<MapCodec<ModTungstenIngotLootModifier>> CODEC = Suppliers.memoize(() ->
            RecordCodecBuilder.mapCodec(inst -> codecStart(inst).and(ForgeRegistries.ITEMS.getCodec()
                    .fieldOf("item").forGetter(m -> m.item)).apply(inst, ModTungstenIngotLootModifier::new)));
    final Item item;
     ...
     */
    protected ModTungstenIngotLootModifier(LootItemCondition[] conditionsIn, Item item) {
        super(conditionsIn);
        this.item = item;
    }
