...
public class ModInfusedGemstonePickaxeItem extends Item {
    public ModInfusedGemstonePickaxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Properties properties) {
        super(properties
