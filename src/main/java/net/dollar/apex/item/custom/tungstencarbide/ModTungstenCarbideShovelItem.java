...
public class ModTungstenCarbideShovelItem extends ShovelItem {
    public ModTungstenCarbideShovelItem(Tier material, float attackDamage, float attackSpeed) {
        super(material, new Item.Properties().attributes(ShovelItem.createAttributes(
